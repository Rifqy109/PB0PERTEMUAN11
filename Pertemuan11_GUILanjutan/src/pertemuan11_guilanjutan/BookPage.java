...
//        btnDelete.setEnabled(frame.isAdmin());
        ...
        btnAdd.addActionListener(e -> {
            ...
            Object[] input = {
            "judul",judul,"penulis",penulis,"Tahun",tahun
        };
        ...
        btnEdit.addActionListener((ActionEvent e) -> {
            ...
            if(row >=0) {
                ...
                JTextField tahun = new JTextField(String.valueOf(book.getTahun()));
    ...
    if (row >= 0) {
        ...
        JOptionPane.showMessageDialog(this, "Pilih buku yang ingin dihapus terlebih dahulu!");
    }
        });
